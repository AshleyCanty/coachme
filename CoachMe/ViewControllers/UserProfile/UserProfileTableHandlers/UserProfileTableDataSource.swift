...
class UserProfileNibs {
    ...
    let GalleryCollectionViewCell = UINib.init(nibName: "GalleryCollectionViewCell", bundle: nil)
...
extension UserProfileViewController: UITableViewDataSource {
    ...
    func setTableView(){
        ...
        self.tableView.register(UserProfileNibs().GalleryCollectionViewCell, forCellReuseIdentifier: "GalleryCollectionViewCell")
